...
/** The five real-world async states a vital component is expected to handle. */
...
/**
 * Machine-readable description for AI / agent consumers. Lets `vital gen` (and
 ...
 * that powers vital's three differentiators: state-completeness (`states`),
