...
import type { RegistryItem } from '@vital/core';
import { hashContent } from '@vital/core';

export const LOCKFILE_NAME = 'vital.lock.json';
...
function emptyLock(registry: string): Lockfile {
  return {
    $schema: 'https://vital/schema/lockfile.json',
    registry,
    items: {},
  };
}
