...
const homeComponents: HC[] = [
  ...
  },
  {
    ...
    kind: 'hook',
    a11y: false,
    desc: 'Form values, validation and submit lifecycle.',
  ...
  },
  {
    ...
    kind: 'component',
    a11y: true,
    desc: 'Accessible label + control + error wiring.',
    states: ['error'],
  },
  {
    name: 'async-form',
    ...
    kind: 'component',
    a11y: true,
    desc: 'Form wrapper that focuses the first invalid field.',
    states: ['error'],
  },
  {
    ...
    kind: 'hook',
    a11y: false,
    desc: 'Debounced server-side validation as you type.',
    states: ['loading', 'error'],
  },
  {
    name: 'multi-select',
