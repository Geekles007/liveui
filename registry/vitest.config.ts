...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@/hooks/use-form': itemFile('use-form/files/use-form.ts'),
      '@/hooks/async-validator': itemFile('async-validator/files/async-validator.ts'),
      '@/hooks/use-stream': itemFile('use-stream/files/use-stream.ts'),
      '@/hooks/use-debounce': itemFile('use-debounce/files/use-debounce.ts'),
      '@/hooks/use-intersection': itemFile('use-intersection/files/use-intersection.ts'),
      '@/hooks/use-clipboard': itemFile('use-clipboard/files/use-clipboard.ts'),
      '@/hooks/use-media-query': itemFile('use-media-query/files/use-media-query.ts'),
      '@/hooks/use-poll': itemFile('use-poll/files/use-poll.ts'),
      '@/components/field': itemFile('field/files/field.tsx'),
      '@/components/async-form': itemFile('async-form/files/async-form.tsx'),
      ...
      '@/components/streaming-list': itemFile('streaming-list/files/streaming-list.tsx'),
      '@/components/presence': itemFile('presence/files/presence.tsx'),
      '@/components/offline-banner': itemFile('offline-banner/files/offline-banner.tsx'),
      '@/components/optimistic-toggle': itemFile('optimistic-toggle/files/optimistic-toggle.tsx'),
      '@/components/dropdown-menu': itemFile('dropdown-menu/files/dropdown-menu.tsx'),
      '@/components/popover': itemFile('popover/files/popover.tsx'),
      '@/components/tooltip': itemFile('tooltip/files/tooltip.tsx'),
      '@/components/accordion': itemFile('accordion/files/accordion.tsx'),
      '@/components/stepper': itemFile('stepper/files/stepper.tsx'),
    },
  },
