# everstate — Roadmap des composants

> En clair : `everstate` est une boîte de **briques d'interface** (boutons, listes,
...
## Couche 1 — Les briques d'état (ce qui rend everstate différent)
...
lisible par l'IA** (pour `everstate gen`).
